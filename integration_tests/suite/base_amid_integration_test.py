...
class BaseDirdIntegrationTest(unittest.TestCase):
    ...
    @classmethod
    def launch_amid_with_asset(cls):
    ...
    @classmethod
    def setUpClass(cls):
        cls.launch_amid_with_asset()

    @classmethod
    def tearDownClass(cls):
        cls.stop_amid_with_asset()

    def get_lookup_result(self, term, profile):
        url = 'http://localhost:15672/api/0.1/directories/lookup/{profile}?term={term}'
